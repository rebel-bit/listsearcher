...
def get_plugin(plugin):
  ...
  while True:
    page += 1
    b = req.get('http://pluginu.com/'+plugin+'/'+str(page), header=Headers)
...
def get_theme(theme):
  ...
  while True:
    page += 1
    d = req.get('https://themetix.com/'+theme+'/'+str(page))
...
def main():
  ...
  {}=============================================
               {}List Searcher v2.5
                          Fixed by Our Priv8ToolsLeaked
   {}Coded By: Tegal {}{}More Tools https://t.me/hackingtoolsprvi8
  {}=============================================
  ...
  choice = raw_input('\n{}root@Tegal {}[MENU]:{} '.format(fy, fr, fre))
  if (choice == '1'):
